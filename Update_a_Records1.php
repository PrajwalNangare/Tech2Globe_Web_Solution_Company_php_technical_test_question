...
if(isset($_GET['submit']))
{
  ...
  $email=$_GET['email'];
  $gender=$_GET['gender'];
  $query="update Emp set name='$name', email='$email', gender='$gender' where id='$id'";
  $data=mysqli_query($conn,$query);
  if($data)
  {
    echo "<font color='green'><center>Record  Updated Successfully.</center> <center><a href='Print_a_Records1.php'>Check Updated List Here</a></center>";
  }
  else
  {
